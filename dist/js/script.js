...
/* harmony import */ var _modules_navScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/navScroll */ "./src/js/modules/navScroll.js");
/* harmony import */ var _modules_langMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/langMenu */ "./src/js/modules/langMenu.js");
...
/* harmony import */ var _modules_formData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/formData */ "./src/js/modules/formData.js");
...
Object(_modules_loader__WEBPACK_IMPORTED_MODULE_5__["default"])();
$(document).ready(function () {
  var top = $('.top');
  Object(_modules_navScroll__WEBPACK_IMPORTED_MODULE_0__["default"])(top);
  Object(_modules_langMenu__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_scrollTop__WEBPACK_IMPORTED_MODULE_2__["default"])(top);
  Object(_modules_formData__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_4__["popup"])();
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_4__["closeModal"])();
});
...
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./popup */ "./src/js/modules/popup.js");
...
var formData = function formData() {
  var form = document.querySelectorAll('form'),
      inputs = document.querySelectorAll('input'); //for each form on submit data goes to server and modal closes

  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault();
      postData(item);
      Object(_popup__WEBPACK_IMPORTED_MODULE_4__["closeModal"])(item);
    });
  }); // clear inputs after posting data except buttons 

  function clearInputs(inputs) {
    var textArea = document.querySelectorAll('textarea').forEach(function (i) {
      return i.value = '';
    });
    inputs.forEach(function (input) {
      if (input.classList.contains('button')) {} else if (input.checked === true) {
        input.checked = false;
      } else {
        input.value = '';
      }
...
var langMenu = function langMenu() {
  ...
  document.addEventListener('click', function (e) {
    if (e.target.parentNode.parentNode.classList.contains('language') || e.target.id == 'lang' || e.target.parentNode.id == 'lang') {} else {
      lang.next().removeClass('language_active');
    }
  });
  lang.next().children().click(function (e) {
    e.preventDefault();
...
/* harmony default export */ __webpack_exports__["default"] = (langMenu);
...
var navScroll = function navScroll(top) {
  var nav = $('nav');
...
/*!*********************************!*\
  !*** ./src/js/modules/popup.js ***!
  \*********************************/
/*! exports provided: popup, closeModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
